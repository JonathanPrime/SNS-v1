<div id="main">
    <div class="container">
    	<br>
        <h3 class="">Cambios de jornada</h3>
        	<br>
        	<form name="form1" method="post" action="regusuario.php">
              ...
              <select class="form-control" name="tidoc">
                ...
                <option>Pasaporte</option>
	      			...
	      			<label for="usr">Fecha de cambio de jornada</label>
	      			<input type="date" class="form-control" name="fecha" autocomplete="off" required>
              <label for="usr">Fecha de cambio de jornada</label>
              <input type="date" class="form-control" name="fecha" autocomplete="off" required>
              <label for="usr">Jornada actual</label>
              <select class="form-control" name="jornadaac">
                    <option>-- ninguna--</option>
                    <option>Diurna</option>
                    <option>Nocturna</option>
                    <option>Madrugada</option>
              </select>
              <label for="usr">Jornada nueva</label>
              <select class="form-control" name="jornadanu">
                    <option>-- ninguna--</option>
                    <option>Diurna</option>
                    <option>Nocturna</option>
                    <option>Madrugada</option>
